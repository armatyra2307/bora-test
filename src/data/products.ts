...
export const products: Product[] = [
  ...
  {
    id: 17,
    name: "Sorena Basin Mixer",
    price: 2500,
    description: "Компактный настенный смеситель, экономящий пространство на раковине. Идеально подходит для небольших ванных комнат.",
    category: "faucet",
    imageUrl: "/images/Sorena Basin Mixer Chrome/photo_3_2025-03-10_13-46-53.jpg",
    images: [
      "/images/Sorena Basin Mixer Chrome/photo_9_2025-03-10_13-46-53.jpg"
    ],
    features: [
      "Однорычажное управление",
      "Современный дизайн",
  ...
  {
    id: 24,
    name: "Sarina Sink  Mixer(with hand spray)",
    price: 5000,
    description: "Компактный настенный смеситель, экономящий пространство на раковине. Идеально подходит для небольших ванных комнат.",
    category: "faucet",
  ...
  {
    id: 27,
    name: "Tiara Basin Mixer Electronic sensor",
    price: 7420,
    description: "Компактный настенный смеситель, экономящий пространство на раковине. Идеально подходит для небольших ванных комнат.",
    category: "faucet",
